...
bool solve(int l, int r, int k) {
    ll entrySum = prefixSum[n - 1];
    l--;
    r--;
    ll addedValue = (r - l + 1) * k;
    ll sub = l == 0 ? prefixSum[r] : prefixSum[r] - prefixSum[l - 1];
    return (entrySum + addedValue - sub) & 1;
}
